...
class ArticleBean{
  ...
  ArticleBean.fromParams({this.errorCode, this.errorMsg, this.data});

  factory ArticleBean(jsonStr) => jsonStr == null ? null : jsonStr is String ? new ArticleBean.fromJson(json.decode(jsonStr)) : new ArticleBean.fromJson(jsonStr);
